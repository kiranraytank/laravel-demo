...
<!--PROMOTIONS AREA-->
<section class="style-three promotions-area section-padding">
            ...
            <div class="menu-discount-offer col-md-12 col-lg-12 col-sm-12 col-xs-12">
                <div class="single-promotions">
                    <div class="promotions-img">
                        <img src="{{ asset('front/img/promotions/promo_slide_1.jpg') }}" alt="">
                    </div>
                ...
                <div class="single-promotions">
                    <div class="promotions-img">
                        <img src="{{ asset('front/img/promotions/promo_slide_2.jpg') }}" alt="">
                    </div>
                    <div class="promotions-details">
                        <h3>40% off for 9'' - 12'' pizza - Wed, Thu, Friday only</h3>
                        <p>Pizza 12 inch + 1 Side Dish + 1,5L Coke Bottle Only From 209,000</p>
                ...
                <div class="single-promotions">
                    <div class="promotions-img">
                        <img src="{{ asset('front/img/promotions/promo_slide_3.jpg') }}" alt="">
                    </div>
                    <div class="promotions-details">
                        <h3>40% off for 9'' - 12'' pizza - Wed, Thu, Friday only</h3>
                        <p>Pizza 12 inch + 1 Side Dish + 1,5L Coke Bottle Only From 209,000</p>
        ...
        <div class="row food-menu-list">
            <div class="mix col-md-6 col-lg-6 col-sm-12 col-xs-12 single-menu breakfast coffee snacks">
                <div class="single-menu-details">
                    <div class="food-menu-img"><img src="{{ asset('front/img/menu/menu_style_two_1.jpg') }}" alt=""></div>
            ...
            <div class="mix col-md-6 col-lg-6 col-sm-12 col-xs-12 single-menu dinner snacks">
                <div class="single-menu-details">
                    <div class="food-menu-img"><img src="{{ asset('front/img/menu/menu_style_two_2.jpg') }}" alt=""></div>
                    <div class="food-menu-details">
            ...
            <div class="mix col-md-6 col-lg-6 col-sm-12 col-xs-12 single-menu breakfast">
                <div class="single-menu-details">
                    <div class="food-menu-img"><img src="{{ asset('front/img/menu/menu_style_two_3.jpg') }}" alt=""></div>
                    <div class="food-menu-details">
            ...
            <div class="mix col-md-6 col-lg-6 col-sm-12 col-xs-12 single-menu dinner lunch breakfast snacks">
                <div class="single-menu-details">
                    <div class="food-menu-img"><img src="{{ asset('front/img/menu/menu_style_two_4.jpg') }}" alt=""></div>
                    <div class="food-menu-details">
            ...
            <div class="mix col-md-6 col-lg-6 col-sm-12 col-xs-12 single-menu lunch coffee">
                <div class="single-menu-details">
                    <div class="food-menu-img"><img src="{{ asset('front/img/menu/menu_style_two_5.jpg') }}" alt=""></div>
                    <div class="food-menu-details">
            ...
            <div class="mix col-md-6 col-lg-6 col-sm-12 col-xs-12 single-menu breakfast">
                <div class="single-menu-details">
                    <div class="food-menu-img"><img src="{{ asset('front/img/menu/menu_style_two_6.jpg') }}" alt=""></div>
                    <div class="food-menu-details">
...
@section('headerClass', 'single-page menu-page')
            ...
            <div class="col-md-12 col-xs-12">
                <div class="barner-text">
                    ...
                    <ul class="page-location">
                        ...
                        <li class="active"><a href="{{ route('menu') }}">Our Menus</a></li>
                    </ul>
                </div>
            </div>
        </div>
